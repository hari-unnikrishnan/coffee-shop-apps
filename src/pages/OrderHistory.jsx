  ...
  const [orders, setOrders] = useState([
    {
      id: 1,
      items: [
        { name: "Espresso", price: 9.5, quantity: 1, image: "/src/assets/image/images.jpg"  }
      ],
      total: 10.5,
      status: "Delivered",
      date: "15 Feb 2026"
    },
     {
      id: 2,
      items: [
        {  name: "Iced Latte", price: 7.5, quantity: 2, image: "/src/assets/image/Latte-kaves-pohar-keszlet-6-db-285-ml6.webp"  }
      ],
      total: 123.5,
      status: "Delivered",
      date: "12 Feb 2026"
   ...
   
    {
      id: 3,
      items: [
        { name: "Cappuccino", price: 10.5, quantity: 1, image: "/src/assets/image/starbucks-coffee-by-nescafe-dolce-gusto-latte-macchiato-coffee-pods-12-capsules.jpg" }
      ],
      total: 10.5,
      status: "Cancelled",
      date: "10 Feb 2026"
